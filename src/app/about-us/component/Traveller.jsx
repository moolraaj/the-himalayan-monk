    ...
    <div className="about_traveller">
      <div className="stats-section">
        <div className="stat-item">
          <img src={iconone.src} alt="icon one" />
        ...
        <div className="stat-item">
          <img src={icontwo.src} alt="icon two" />
          <div className='both-v-l'>
        ...
        <div className="stat-item">
          <img src={iconthree.src} alt="icon three" />
          <div className='both-v-l'>
        ...
        <div className="stat-item">
          <img src={iconfour.src} alt="icon four" />
          <div className='both-v-l'>
      ...
      <div className='who-feature'>
        <div className="who-we-are-section">
          ...
          <h4>WHAT WE DO?</h4>
          <p>We work on different aspects to make your travel experience just similar to the way you had dreamt it of as. We get the travelers from all around the world together and explore the diversities that different cultures have to offer, while helping you discover yourself a little more along the way.</p>
        </div>

        <div className="features-section">
          <div className="feature-item-outer">
            <div className="feature-item">
              <div className="feature-icon"><img src={contactone.src} alt="contact one" /></div>
          ...
          <div className="feature-item-outer">
            <div className="feature-item">
              <div className="feature-icon"><img src={contactfive.src} alt="contact five" /></div>
              <div className='both-w-c'>
                <div className="feature-title">Guided Tours</div>
                <div className="feature-description">Discover the world with confidence through our guided tours at [Your Company Name]. Our expert guides are passionate about sharing their knowledge and insights, ensuring you experience the rich culture, history, and hidden gems of each destination. Whether you’re exploring ancient ruins, vibrant cities, or breathtaking landscapes, our curated itineraries provide a perfect blend of adventure and relaxation. Join us for a guided tour and embark on an extraordinary journey today!</div>
              </div>
            </div>
          </div>
          <div className="feature-item-outer">
            <div className="feature-item">
              <div className="feature-icon"><img src={contactfour.src} alt="contact four" /></div>
              <div className='both-w-c'>
          ...
          <div className="feature-item-outer">
            <div className="feature-item">
              <div className="feature-icon"><img src={contactlast.src} alt="contact last" /></div>
              <div className='both-w-c'>
