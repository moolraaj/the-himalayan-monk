...
//         const resp = await api.fetchTourPackages(searchParams);
...
//       fetchSearchResults();
//     }
//   }, [searchTerm, packageType, minPrice, maxPrice]);
...
//           </div>
//         </div>
//         <button className="search-button" onClick={() => {}}>Search For Packages</button>
